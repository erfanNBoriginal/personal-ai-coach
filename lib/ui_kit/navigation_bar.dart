...
class _NavigationBarState extends State<NavigationBar> {
  ...
  static const double _collapsedHeightPx = 144;
                        ...
                        child: GestureDetector(
                          ...
                          onVerticalDragUpdate: (details) {
                            ...
                            final newSize = (_sheetController.size - delta)
                                .clamp(minChildSize, _maxChildSize);
...
class PrimaryItem extends StatelessWidget {
  ...
  const PrimaryItem({super.key, required this.path});

  @override
  Widget build(BuildContext context) {
    return U.Image.icon(path: path, size: 36);
  }
}
